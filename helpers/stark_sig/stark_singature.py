...
from helpers.stark_sig.math_utils import ECPoint, div_mod, ec_add, ec_double, ec_mult, is_quad_residue, sqrt_mod
...
def private_to_stark_key(priv_key: int) -> [int, int]:
